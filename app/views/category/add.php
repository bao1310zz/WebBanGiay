        ...
        <div class="col-lg-6 col-md-8">
            <div class="custom-card">
                <div class="text-center mb-5">
                    <h3 class="font-weight-bold text-uppercase" style="letter-spacing: 2px;">Thêm Danh Mục</h3>
                    <div style="height: 2px; width: 50px; background-color: #c89b3c; margin: 15px auto 0;"></div>
                </div>

                <form method="POST" action="/WebBanGiay/Category/save">
                    ...
                    <div class="d-flex justify-content-between border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-gold px-5 py-2">Lưu Danh Mục</button>
                    </div>
                </form>
            </div>
        </div>
